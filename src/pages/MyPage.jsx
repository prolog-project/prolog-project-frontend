            ...
            <div id="main" className="grid-2-3">
                <div className="main-div">
                    ...
                    <div className="note-div">
                        <div className="justify-main-left justify-sub-center justify-wrap gap-20">
                    ...
                    <div className="sub-div justify-column gap-10 m-t-30">
                        <div className="justify-main-between justify-sub-center">
                            <h3>일지 캘린더</h3>
                            <button className="btn-blue-blue h-35 w-100" onClick={() => navigate('/note/write')}>일지 작성</button>
                        </div>
