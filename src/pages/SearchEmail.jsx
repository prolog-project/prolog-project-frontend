            ...
            <div id="main" className="grid-1-3">
                <div className="main-div">
                    ...
                    <div className="sub-div2 justify-column justify-sub-center gap-10">
                        ...
                        <button className="btn-white-blue h-45 w-100-per" onClick={() => fn_showModal(true)}>이메일 찾기</button>
                    </div>
                </div>
            </div>   
            { showModal ? <Modal fn_showModal = {fn_showModal} delimiter = "findEmail" /> : null }
        </>
    );
}
